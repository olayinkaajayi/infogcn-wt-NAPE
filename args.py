...
def get_parser():
    ...
    parser.add_argument('--PE_name', type=str, default='', help='if you choose to use the NAPE encoding')
    parser.add_argument('--model_name', type=str, default='paper_infogcn', help='name to pass to tensorboardX')
    parser.add_argument('--model_names_file', type=str, default='model_names.txt', help='file we save the model names')
    ...
    parser.add_argument('--flops_filename', type=str, default='paper_infogcn_bwd_FLOPs.txt', help='file we save the model names')
